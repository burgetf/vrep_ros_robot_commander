...
class Mission:
    ...
    def __init__(self, name):
        ...
        rospy.Subscriber("/sphere_coefs", Float32MultiArray, self.marker_inf_cb, queue_size=1)
        rospy.spin()
    ...
    def gripper_final_action(self):
        ...
        final_q_ik = self.kdl_kin.inverse(final_pose_T, np.array(self.end_eff_current_pose)+0.5)
